                                ...
                                <tr>
                                    ...
                                    ?>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="CRUD/Galeri/update.php?id=<?=$data['ID']?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                                        <a href="CRUD/Galeri/delete.php?id=<?=$data['ID']?>" onclick="return confirm('Apakah Yakin Ingin Dihapus?')"><i class="fa-solid fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                    <?php
                                            }
